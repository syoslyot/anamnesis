...
1. **Background** — What research question motivated this experiment? Summarize the parent hypothesis and current belief at the time.
...
Read the parent hypothesis at `.anamnesis/hypotheses/<hypothesis-id>.md` for context.
